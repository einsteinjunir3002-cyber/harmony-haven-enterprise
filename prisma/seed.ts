...
async function main() {
  ...
  const kowahProducts = [
    ...
    },
    {
      brandId: kowahBrand.id,
      categoryId: kowahCatSavory.id,
      name: "Party Jollof & Grilled Chicken Box",
      slug: "party-jollof-grilled-chicken-box",
      description: "Smoky Ghanaian firewood-style party jollof rice served with succulent seasoned grilled chicken, sweet golden fried plantain (kelewele), and fresh coleslaw.",
      shortDescription: "Signature smoky party jollof rice with grilled chicken & fried plantain.",
      price: 75.0,
      compareAtPrice: 85.0,
      type: "MADE_TO_ORDER",
      featured: true,
      images: JSON.stringify(["/images/gallery/WhatsApp Image 2026-09-03 at 10.22.02 PM.jpeg", "/images/gallery/WhatsApp Image 2026-09-03 at 10.20.31 PM.jpeg"]),
      variants: [
        { name: "Single Pack (1 Quarter Chicken + Kelewele)", priceAdjustment: 0, stockQuantity: 50 },
        { name: "Double Trouble (2 Quarters + Goat Chunks)", priceAdjustment: 35, stockQuantity: 30 },
        { name: "Mini Chafing Dish Feeder (Serves 6)", priceAdjustment: 190, stockQuantity: 15 },
      ],
    },
    {
      brandId: kowahBrand.id,
      categoryId: kowahCatHotBox.id,
      name: "Peppered Gizzard & Kelewele Platter",
      slug: "peppered-gizzard-kelewele-platter",
      description: "Spicy pan-seared tender gizzard tossed in caramelised onions and bell peppers, paired with sweet ginger-spiced fried ripe plantain cubes.",
      shortDescription: "Tender peppered gizzard paired with spiced golden kelewele cubes.",
      price: 65.0,
      compareAtPrice: 75.0,
      type: "MADE_TO_ORDER",
      featured: false,
      images: JSON.stringify(["/images/gallery/WhatsApp Image 2026-09-03 at 10.27.18 PM.jpeg", "/images/gallery/WhatsApp Image 2026-09-03 at 10.20.31 PM.jpeg"]),
      variants: [
        { name: "Regular Box", priceAdjustment: 0, stockQuantity: 40 },
        { name: "Large Combo with Extra Shito & Sausage", priceAdjustment: 30, stockQuantity: 25 },
      ],
    },
  ];
  ...
  const heartlinesProducts = [
    ...
    },
    {
      ...
      description: "Timeless poetic love letters, anniversary declarations, and wedding vows scribed on handmade deckle-edge paper and sealed with customized wax monogram.",
      shortDescription: "Handmade deckle-edge parchment vow letter sealed with luxury wax.",
      price: 130.0,
      ...
      images: JSON.stringify(["/images/gallery/WhatsApp Image 2026-09-03 at 10.14.23 PM.jpeg", "/images/gallery/WhatsApp Image 2026-09-03 at 10.14.22 PM.jpeg"]),
      variants: [
        { name: "Vintage Manuscript in Wooden Box", priceAdjustment: 0, stockQuantity: 30 },
    ...
    },
    {
      brandId: heartlinesBrand.id,
      categoryId: heartCatVerseVelvet.id,
      name: "Executive Corporate Appreciation Suite",
      slug: "executive-corporate-appreciation-suite",
      description: "Tailored corporate gifting box containing leather stationery, luxury desk accessories, customized corporate appreciation poem, and fine confectionery.",
      shortDescription: "Prestige corporate gratitude and executive celebration gift hamper.",
      price: 480.0,
      compareAtPrice: 550.0,
      type: "CUSTOM_PRODUCT",
      featured: true,
      images: JSON.stringify(["/images/gallery/WhatsApp Image 2026-09-03 at 10.57.01 PM.jpeg", "/images/gallery/WhatsApp Image 2026-09-03 at 10.25.52 PM (1).jpeg"]),
      variants: [
        { name: "Single Executive Hamper", priceAdjustment: 0, stockQuantity: 20 },
